...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			<dt class="selected"><i class="Hui-iconfont">&#xe616;</i> 类别管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd style="display:block">
				<ul>
					<li class="current">
						<a href="article-list.html" title="类别管理">类别管理</a>
					</li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li>
						<a href="product-brand.html" title="查看订单">查看订单</a>
					</li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li>
						<a href="member-list.html" title="查看用户">查看用户</a>
					</li>
					<li>
						<a href="member-del.html" title="编辑会员信息">编辑会员信息</a>
					</li>
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li>
						<a href="admin-role.html" title="管理商品">管理商品</a>
					</li>
		...
		<dl id="menu-tongji">
			...
			<dd>
				<ul>
					<li>
						<a href="charts-1.html" title="销量统计">销量统计</a>
					</li>
					<li>
						<a href="charts-2.html" title="营业额">营业额</a>
					</li>
				</ul>
			</dd>
		</dl>
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a class="btn btn-primary radius" data-title="添加类别" _href="article-add.html" onclick="article_add('添加资讯','article-add.html')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加类别</a>
				</span>
				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
						<tr class="text-c">
							...
							<td>10001</td>
							<td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="article_edit('查看','article-zhang.html','10001')" title="查看">类别</u></td>
							<td>行业动态</td>
							<td>H-ui</td>
							<td>2017-08 11:11:42</td>
							<td>21212</td>
							...
							<td class="f-14 td-manage"><a style="text-decoration:none" onClick="article_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a>
								<a style="text-decoration:none" class="ml-5" onClick="article_edit('类别编辑','article-add.html','10001')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
