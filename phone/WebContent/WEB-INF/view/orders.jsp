...
<body>
	<div class="Navi">
		<img id="shopLogo"
			...
			src="${pageContext.request.contextPath }/resources/image/shopLogo.png"> <img id="head" src="${pageContext.request.contextPath }/${sessionScope.curuser.u_pic}"
			class="img-circle" width="5%" height="10%">
	</div>
