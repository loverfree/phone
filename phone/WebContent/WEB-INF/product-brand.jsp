	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd style="display: block;">
				<ul>
					<li class="current"><a href="product-brand.html" title="查看订单">查看订单</a></li>
		...
		<article class="cl pd-20">
			<div class="text-c">
				<form class="Huiform" method="post" action="" target="_self">
					<input type="text" placeholder="订单名称" value="" class="input-text" style="width:120px">
					...
					<a href="javascript:void();" class="btn btn-primary upload-btn"><i class="Hui-iconfont">&#xe642;</i> 订单</a>
					<input type="file" multiple name="file-2" class="input-file">
					</span> <span class="select-box" style="width:150px">
					<select class="select" name="brandclass" size="1">
						<option value="1" selected>订单</option>
